...
document.addEventListener("DOMContentLoaded", function() {
  ...
  document
    ...
    .addEventListener("mousedown", drawScreen);
  ...
  if (isMobile) {
    ...
    penElement.addEventListener("touchstart", function() {
      penActive = true;
    });
    penElement.addEventListener("touchend", function() {
      penActive = false;
    });
    penElement.addEventListener("touchmove", movePen);
    penElement.addEventListener("mousedown", function() {
      penActive = true;
    });
    penElement.addEventListener("mouseup", function() {
      penActive = false;
    });
